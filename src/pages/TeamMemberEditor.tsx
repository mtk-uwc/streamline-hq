...
export default function TeamMemberEditor() {
  ...
  const handlePost = () => {
    console.log("Publishing team member...");
  };

  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-foreground mb-2">Adding a Team Member</h1>
      </div>
        ...
        <CardContent className="p-6">
          <div className="border-2 border-dashed border-muted-foreground/20 rounded-lg p-12 text-center hover:border-muted-foreground/40 transition-colors">
            ...
            <label htmlFor="image-upload" className="cursor-pointer">
              ...
              <p className="text-muted-foreground font-medium">Upload Image</p>
              {profileImage && (
                <p className="text-sm text-primary mt-2">{profileImage.name}</p>
              )}
            </label>
          </div>
        </CardContent>
      ...
      <div className="space-y-4">
        <Card className="shadow-card bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200">
          <CardContent className="p-4">
            <Input
              placeholder="Name and Surname of Person"
              value={name}
        ...
        <Card className="shadow-card bg-gradient-to-r from-orange-100 to-orange-200 border-orange-200">
          <CardContent className="p-4">
            <Input
      ...
      <Card className="shadow-card">
        <CardHeader className="pb-2">
          <CardTitle className="text-sm text-muted-foreground">Description of staff member, etc.</CardTitle>
        </CardHeader>
        <CardContent>
          <Textarea
            placeholder="Enter a detailed description of the team member..."
            value={description}
